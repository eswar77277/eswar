$(document).ready(function() {
    ...
    $(document).on('click', '#save-theme', function(e){
		...
		headline = 'Are you sure want to Save This Template ?';
        paragraph = 'Lorem ipsum dolor sit amet, consectetur adipiscing<br/><span class="semi_bold" style="color: #323232;">250 credits</span> monthly. and <a href="https://www.stampready.net/terms/privacy-policy/index.php" style="color: #69c0af; text-decoration: none;" class="semi_bold">Privacy Policy</a>.<br/>' +
            '<br/> If you want to Download Now, <a href="#" style="color: #69c0af; text-decoration: none;" class="semi_bold" target="_blank">Click here </a>';
